...
namespace ExitGames.Client.Photon
{
    ...
    public class SocketWebTcp : IPhotonSocket, IDisposable
    {
        ...
        public SocketWebTcp(PeerBase npeer) : base(npeer)
        {
            ...
            if (this.Report//DebugOfLevel(//DebugLevel.INFO))
            {
        ...
        public void Dispose()
        {
            ...
            if (this.sock != null)
            {
                ...
                {
                    this.Enqueue//DebugReturn(//DebugLevel.INFO, "Exception in SocketWebTcp.Dispose(): " + ex);
                }
            }
        ...
        public override PhotonSocketError Send(byte[] data, int length)
        {
            ...
            try
            {
                ...
                //if (this.Report//DebugOfLevel(//DebugLevel.ALL))
                //{
                                ...
                                else
                                {
                                    ...
                                    if (inBuff.Length > 0)
                                    {
                                        ...
                                        catch (Exception e)
                                        {
                                            ...
                                            {
                                                if (this.Report//DebugOfLevel(//DebugLevel.ERROR))
                                                {
                                                    this.Enqueue//DebugReturn(//DebugLevel.ERROR, "Receive issue. State: " + this.State + ". Server: '" + this.ServerAddress + "' Exception: " + e);
                                                }
