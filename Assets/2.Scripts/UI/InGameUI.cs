...
public class InGameUI : MonoBehaviour
{
    ...
    public bool IsControlsPanelActive { get; private set; }
    ...
    {
        _hudPanel.SetActive(!active);
        _escPanel.SetActive(active);
    }

    public void ShowControlsPanel(bool active)
    {
        _controlsPanel.SetActive(active);
        IsControlsPanelActive = active;
    }
